...
class CsoundScoreConverterTest(unittest.TestCase):
    def setUp(self):
        self.converter = converters.csound.CsoundScoreConverter(
            "tests/converters/csound/test.sco", p4=lambda event: event.pitch.frequency
        )
    ...
    #     }
    #     pfields = converters.csound.CsoundScoreConverter._generate_pfield_mapping(
    #         pfield_key_to_function_mapping
    #     )
