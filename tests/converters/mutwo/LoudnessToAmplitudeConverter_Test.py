...
class LoudnessToAmplitudeConverterTest(unittest.TestCase):
    def test_decibel_to_amplitude_ratio(self):
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.decibel_to_amplitude_ratio(0),
            1,
        )
        self.assertEqual(
            round(
                converters.mutwo.LoudnessToAmplitudeConverter.decibel_to_amplitude_ratio(
                    -6
                ),
                2,
            ),
    ...
    def test_decibel_to_power_ratio(self):
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.decibel_to_power_ratio(0), 1
        )
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.decibel_to_power_ratio(-6),
            0.251188643150958,
        )
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.decibel_to_power_ratio(6),
    ...
    def test_sone_to_phon(self):
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.sone_to_phon(1), 40
        )
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.sone_to_phon(2), 50
        )
        self.assertEqual(
            converters.mutwo.LoudnessToAmplitudeConverter.sone_to_phon(0.5),
            31.39434452534506,
        )

    def test_convert(self):
        converter = converters.mutwo.LoudnessToAmplitudeConverter(1)
        ...
        converter = converters.mutwo.LoudnessToAmplitudeConverter(0.5)
